...
Configs.model = nn.Sequential(
    nn.Conv2d(1 if Configs.gray_scale else 3, 69, kernel_size=3, stride=1, padding=1, dilation=1, bias=False),
    nn.BatchNorm2d(69),
    nn.ReLU(inplace=True),
    nn.Conv2d(69, 69, kernel_size=3, stride=1, padding=2, dilation=2, bias=False),
    nn.BatchNorm2d(69),
    nn.ReLU(inplace=True),
    nn.AvgPool2d(2),
    nn.Conv2d(69, 69, kernel_size=3, stride=1, padding=4, dilation=4, bias=False),
    nn.BatchNorm2d(69),
    nn.ReLU(inplace=True),
    nn.AvgPool2d(2),
    nn.Conv2d(69, 69, kernel_size=3, stride=1, padding=8, dilation=8, bias=False),
    nn.BatchNorm2d(69),
    nn.ReLU(inplace=True),
    nn.AvgPool2d(2),
    nn.Conv2d(69, 32, kernel_size=3, stride=1, padding=1, dilation=1, bias=False),
    nn.BatchNorm2d(32),
    nn.ReLU(inplace=True),
    nn.Conv2d(32, Configs.num_classes, kernel_size=3, stride=1, padding=1, dilation=1, bias=False),
